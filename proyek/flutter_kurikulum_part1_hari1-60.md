...
jangan gunakan syntax code yang sudah deprecated di 2026, versi library yang paling up to date mulai dari inisialisasi proyek, sertakan code bash (bukan script sh) untuk meng-copy semua file yang di download, lokasi semua file yang di download akan ditaruh di /lib/download copy ke masing-masing folder.
